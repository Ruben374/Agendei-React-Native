...
import ClientSetting from "../screens/ClientSetting";
import Search from "../screens/Search";
import Categorys from "../screens/Categorys";
import EstServices from "../screens/EstServices";
import RattingsAndReviews from "../screens/RattingsAndReviews";
...
export default () => (
  ...
  >
    ...
    <Stack.Screen name="ClientSetting" component={ClientSetting} />
    <Stack.Screen name="Search" component={Search} />
    <Stack.Screen name="Categorys" component={Categorys} />
    <Stack.Screen name="EstServices" component={EstServices} />
    <Stack.Screen name="RattingsAndReviews" component={RattingsAndReviews} />
  </Stack.Navigator>
);
